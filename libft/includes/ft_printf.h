...
void				ft_putnbr_max(u_int64_t n, t_pf *pf);
void				ft_putstr_non_printable(const char *s, size_t n, t_pf *pf);
int64_t			ft_abs_max(int64_t a);
...
void				ft_gtvar_u_int64_t(t_pf *pf, va_list va);
void				ft_gtvar_ushort_int(t_pf *pf, va_list va);

void				ft_puthex_max(u_int64_t n, int maj, t_pf *pf);
void				ft_putoctal_max(u_int64_t n, t_pf *pf);
